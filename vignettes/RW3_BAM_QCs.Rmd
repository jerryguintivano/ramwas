---
title: "3. BAM Quality Control Measures"
date: "`r Sys.Date()`"
output:
...
`Summary_QC.txt` -- formatted for viewing in Excel and
...
To capture protocol variability, 
...
This 'sqrt peak' sensitivity can be used as a laboratory technical covariate in 
