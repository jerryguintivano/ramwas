...
in a form of a .rds file (`filecpgset` parameter).
...
Note: SNPs were obtained from the 1000 Genomes super populations (Phase 3 data, [more info](http://www.internationalgenome.org/category/population/)). 
Only SNPs with minor allele frequency above 1% are included. 
In silico alignment experiments assumed 75 bp single-end reads and alignment with [Bowtie 2](http://bowtie-bio.sourceforge.net/bowtie2/manual.shtml).
...
We do NOT advice using all dbSNP144 SNPs, as it causes an large number of CpGs that almost never occur in the population.
