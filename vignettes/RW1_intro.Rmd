...
while correctingfor top PCs and known covariates, and 
6) multi-marker analysis using elastic net.
...
Then, `ramwas7multiMarker` trains elastic net on the top CpGs from each of 
