...
*   `qc` -- directory with a number of quality control (QC) plots, 
    ...
    * `isolated_distance` -- plots showing distribution of distances
    ...
    basepairs away from any other CpG.\
...
```{r plotFSD, echo=FALSE, warning=FALSE, message=FALSE}
...
*   `covmat.rds` and `eigen.rds` - RDS files with the covariance matrix and
...
```{r tableMWAS, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r plotCV1, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r plotCV2, echo=FALSE, warning=FALSE, message=FALSE}
