---
title: "4. Joint Analysis of Methylation and Genotype Data"
date: "`r Sys.Date()`"
output:
...
```{r plotQQ2, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6, fig.height=6}
...
```{r plotQQ1, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6, fig.height=6}
pfull = parameterPreprocess(param)
