...
#      filecpgset = paste0(dir,"/Simulated_chromosome.rds"),
#      minfragmentsize = 75,
#      maxfragmentsize = 250,
#      cputhreads = 2,
...
#      message(paste(list.files(paste0(dir,"/coverage_norm_20/PCA_00_cvrts")),
#                    collate="\n"))
#      message("Correlation of top PCs with covariates are:");
#      show(head( read.table(
#          paste0(dir,"/coverage_norm_20/PCA_00_cvrts/PC_vs_covariates_corr.txt"),
#          sep = "\t", header = TRUE)))
#      message("P-values for the associuation of top PCs with covariates are:");
#      show(head( read.table(
#          paste0(dir,
#                 "/coverage_norm_20/PCA_00_cvrts/PC_vs_covariates_pvalue.txt"),
#          sep = "\t", header = TRUE)))
#  }
...
#          paste0(dir,"/coverage_norm_20/PCA_00_cvrts/Testing_casecontrol_0_PCs")),
#          collate="\n"))
#      message("The top MWAS findings are:");
#      show(head( read.table(paste0(dir,
#        "/coverage_norm_20/PCA_00_cvrts/Testing_casecontrol_0_PCs/Top_tests.txt"),
#        sep = "\t", header = TRUE)))
#      qqPlotFast(fm.load(paste0(dir,
#         "/coverage_norm_20/PCA_00_cvrts/Testing_casecontrol_0_PCs",
#         "/Stats_and_pvalues"))[,3])
...
#      })
#      message("The generated files and directories in MWAS directories are:");
#      message(paste(list.files(paste0(dir,
#         "/coverage_norm_20/PCA_00_cvrts/Testing_age_0_PCs")), collate="\n"))
#      message("The top MWAS findings are:");
#      show(head( read.table(paste0(dir,
#             "/coverage_norm_20/PCA_00_cvrts/Testing_age_0_PCs/Top_tests.txt"),
#             sep = "\t", header = TRUE)))
#      qqPlotFast(fm.load(paste0(dir,"/coverage_norm_20/PCA_00_cvrts/",
#                                "Testing_age_0_PCs/Stats_and_pvalues"))[,3])
...
#      })
#      })
#      message("The generated files and directories in Multi-marker directory:");
#      message(paste(list.files(paste0(dir,
#         "/coverage_norm_20/PCA_00_cvrts/Testing_age_0_PCs/CV_10_folds")),
#         collate="\n"))
#  }
