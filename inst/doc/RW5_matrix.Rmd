---
title: "2.1. Analyzing Data from Other Methylation Platforms or Data Types"
...
vignette: >
  %\VignetteIndexEntry{2.1. Analyzing data from other sources}
...
RaMWAS can also be useful for analysis of 
methylation measurements from other  platforms 
(e.g. Illumina HumanMethylation450K array) or
data types such as gene expression levels or genotypes.
RaMWAS can perform several analysis steps on such data: 
principal component analysis (PCA), 
association studies (GWAS, TWAS), 
and elastic net analysis with cross validation.

## Import data from other sources

Here we illustrate how data from other sources can be imported into RaMWAS.

Namely, we create data files in the same format as produced by
